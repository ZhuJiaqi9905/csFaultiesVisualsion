let pict1 = {
        ...
        .on('mouseover', (e, d) => {
           ...
           let element =  document.getElementsByClassName(className)[0]
            ...
            for(let i = 0; i < childs.length; i++){
               // console.log(childs[i].getAttribute("opacity"))
                childs[i].setAttribute("opacity", 1)
            //    console.log(childs[i].getAttribute("opacity"))
                //childs[i].setAttribute("stroke", pict2.highlightColorSet[i])
            ...
            //tooltip.html(content)
              //  .style('left', (pict1.xScale(parseInt(d[pict1.x_attr])) + 5) + 'px')
              //  .style('top', (pict1.yScale(parseInt(d[pict1.y_attr])) + 5)+ 'px')
    ...
    drawMain: (data) => {
        ...
        pict1.drawAxis(svg, data)
        pict1.drawPoints(svg, data)
